...
<body>
    <div class="container">
        ...
        <div class="button-group">
            <a href="https://www.iihf.com/en/events/2026/olympic-m/schedule" target="_blank" style="flex: 1;"><button class="btn btn-primary">📊 IIHF Schedule</button></a>
            <a href="https://www.peacocktv.com/watch/2026-milan-cortina-olympics" target="_blank" style="flex: 1;"><button class="btn btn-primary">📺 Peacock TV</button></a>
        ...
        <div id="standings" class="content">
            <div style="background: #e3f2fd; border-left: 4px solid #2196F3; padding: 12px; margin-bottom: 15px; border-radius: 4px; color: #1565c0; font-size: 0.9em;">📊 Standings update as scores are entered.</div>
            <div id="standings-content"></div>
        </div>
        
        <div id="playoffs" class="content">
            <div style="background: #e3f2fd; border-left: 4px solid #2196F3; padding: 12px; margin-bottom: 15px; border-radius: 4px; color: #1565c0; font-size: 0.9em;">🏆 Enter qualification playoff scores to advance the bracket.</div>
    ...
    <script>
        ...
        function generatePlayoffs() {
            ...
            qual.forEach(m => {
                ...
                if (playoff[m.id]) {
                    html += `<div style="color: #4CAF50; font-weight: bold;">✓ Winner: ${playoff[m.id]}</div>`;
                } else {
            ...
            if (qWinners.every(w => w)) {
                ...
                if (qfWinners.every(w => w)) {
                    ...
                    if (sfWinners.every(w => w)) {
                        // Gold
                        html += '<h3>🥇 Gold Medal (SUN 22 FEB)</h3>';
                        html += `<div class="match-box" style="background: #FFD700; border: 2px solid #FFB700;"><strong>${sfWinners[0]} vs ${sfWinners[1]}</strong>`;
                        if (playoff['gold']) {
                            html += `<div style="color: #fff; font-weight: bold; font-size: 1.1em;">✓ CHAMPION: ${playoff['gold']}</div>`;
                        } else {
                        ...
                        // Bronze
                        html += '<h3>🥉 Bronze Medal (SAT 21 FEB)</h3>';
                        ...
                        if (playoff['bronze']) {
                            html += `<div style="color: #fff; font-weight: bold; font-size: 1.1em;">✓ 3RD PLACE: ${playoff['bronze']}</div>`;
                        } else {
